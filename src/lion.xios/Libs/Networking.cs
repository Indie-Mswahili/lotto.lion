...
namespace Lion.XiOS.Libs
{
    ...
    public class Networking
    {
        ...
        public ApiResult<bool> CheckMailAddress(string guest_token, string mail_address, string check_number)
        {
            var _params = new Dictionary<string, object>();
            {
                _params.Add("mail_address", mail_address);
            ...
            var _result = ApiTokenCall<bool>(guest_token, "/api/user/CheckMailAddress", _params);
            return _result;
        }
