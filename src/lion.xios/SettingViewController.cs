...
namespace Lion.XiOS
{
    public partial class SettingViewController : UITableViewController
    {
        ...
        private void ExcuteLogout()
        {
            ...
            var viewCont2 = this.Storyboard.InstantiateViewController("loginView") as LoginViewController;
            this.NavigationController.PushViewController(viewCont2, true);

            ConfigHelper.ShowConfirm("알림", "로그아웃 되었습니다", "확인");
        }
